                ...
                <div className='slide_Header'>
                    ...
                    <div className="slide_right">
                        ...
                        <div className="slide_calender">
                            <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6" onClick={goToCalendar} >
