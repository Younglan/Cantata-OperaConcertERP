    ...
    return (
        <div className={`slide_board ${isOpen ? 'open' : 'close'}`}>
            <div className='slide_Header'>
                <div className='slide_menu' onClick={handleToggle}> {/*닫기 버튼*/}
                ...
                <div className="slide_right">
                    <div className="slide_login">
                        <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" transform='rotate(180)'>
                    ...
                    <div className="slide_calender">
                        <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
